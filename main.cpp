...
void texts()
{
    ...
    if(counter>400&& counter<800)
        drawstring(160, 250, 0.0, "Hi turtle..");
    if(counter>800&& counter<1200)
        drawstring(100, 250, 0.0, "You are such a slow animal");
    ...
    glPopMatrix();
        ...
        glColor3f(0.0, 0.0, 1);
        drawstring(215, 300, 0.0, "--> SLOW & STEADY WIN THE RACE ---->");
        glColor3f(0.0, 0.0, 1);
        drawstring(215, 285, 0.0, "----------------------------");
        glColor3f(1.0, 0, 1);
        drawstring(500, 100, 0.0, "Made by:");
        glColor3f(1.0, 0, 1);
        drawstring(500, 80, 0.0, "Rahul Rana");
        glColor3f(1.0, 0, 1);
        drawstring(500, 60, 0.0, "Roll no: 161369");
        glColor3f(1.0, 0, 1);
        drawstring(500, 40, 0.0, "Batch: B7 (CSE)");
        glColor3f(1.0, 0, 1);
        drawstring(500, 20, 0.0, "JUIT , SOLAN, H.P");
    }
